...
VALUES (1, N'Aspirin is a common over-the-counter medication that is used to reduce pain, fever.', N'Aspirin', N'Analgesic'),
(2, N'Ibuprofen is a nonsteroidal anti-inflammatory drug (NSAID) commonly used to relieve pain.', N'Ibuprofen', N'NSAID'),
(3, N'Simvastatin is a statin medication used to lower cholesterol levels in the blood.', N'Simvastatin', N'Statin');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Description', N'Name', N'Type') AND [object_id] = OBJECT_ID(N'[Medicaments]'))
...
VALUES (1, '2023-12-20T22:32:08.4204949+01:00', '2023-12-23T22:32:08.4204979+01:00', 1, 2),
(2, '2023-11-05T00:00:00.0000000', '2023-12-30T00:00:00.0000000', 1, 3),
(3, '2023-12-24T22:32:08.4204982+01:00', '2024-01-02T22:32:08.4204984+01:00', 2, 1),
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20231218213208_InsertValues', N'7.0.0');
GO
...
ALTER TABLE [Prescription_Medicaments] ADD [MedicamentId] int NULL;
GO

ALTER TABLE [Prescription_Medicaments] ADD [PrescriptionId] int NULL;
GO

UPDATE [Prescription_Medicaments] SET [MedicamentId] = NULL, [PrescriptionId] = NULL
WHERE [IdMedicament] = 1 AND [IdPrescription] = 2;
SELECT @@ROWCOUNT;

GO

UPDATE [Prescription_Medicaments] SET [MedicamentId] = NULL, [PrescriptionId] = NULL
WHERE [IdMedicament] = 2 AND [IdPrescription] = 4;
SELECT @@ROWCOUNT;

GO

UPDATE [Prescription_Medicaments] SET [MedicamentId] = NULL, [PrescriptionId] = NULL
WHERE [IdMedicament] = 3 AND [IdPrescription] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Prescription_Medicaments] SET [MedicamentId] = NULL, [PrescriptionId] = NULL
WHERE [IdMedicament] = 3 AND [IdPrescription] = 3;
SELECT @@ROWCOUNT;

GO

UPDATE [Prescriptions] SET [Date] = '2023-12-24T14:21:16.8769151+01:00', [DueDate] = '2023-12-27T14:21:16.8769177+01:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Prescriptions] SET [Date] = '2023-12-28T14:21:16.8769180+01:00', [DueDate] = '2024-01-06T14:21:16.8769181+01:00'
WHERE [Id] = 3;
SELECT @@ROWCOUNT;

GO

CREATE INDEX [IX_Prescription_Medicaments_MedicamentId] ON [Prescription_Medicaments] ([MedicamentId]);
GO

CREATE INDEX [IX_Prescription_Medicaments_PrescriptionId] ON [Prescription_Medicaments] ([PrescriptionId]);
GO

ALTER TABLE [Prescription_Medicaments] ADD CONSTRAINT [FK_Prescription_Medicaments_Medicaments_MedicamentId] FOREIGN KEY ([MedicamentId]) REFERENCES [Medicaments] ([Id]);
GO

ALTER TABLE [Prescription_Medicaments] ADD CONSTRAINT [FK_Prescription_Medicaments_Prescriptions_PrescriptionId] FOREIGN KEY ([PrescriptionId]) REFERENCES [Prescriptions] ([Id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20231222132116_UpdateModels', N'7.0.0');
GO
